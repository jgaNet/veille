# Échéances et suivis — flux ecologie

Voir `ecologie/CONSIGNES.md`, § 8. Chaque passage lit ce fichier avant de
chercher.

## Échéances

COP et sessions de négociation, publications attendues (GIEC, IPBES, bilans
annuels), votes et entrées en application de textes, audiences et délibérés.
Seules figurent ici des dates tirées d'une source officielle, avec le lien.
Une échéance est signalée une fois lorsqu'elle approche, si elle le mérite,
...
- 2026-12-30 — règlement européen « déforestation importée » (RDUE/EUDR) : entrée en application pour les grands et moyens opérateurs, ainsi que pour les micro et petits opérateurs déjà couverts par le règlement bois — [politique] — confirmé (règlement modifié en déc. 2024 puis en déc. 2025) — https://environment.ec.europa.eu/topics/forests/deforestation/regulation-deforestation-free-products_en (relevé le 2026-09-20) —
- 2027-06-30 — RDUE/EUDR : entrée en application pour les micro et petits opérateurs — [politique] — confirmé — même source —
- 2027-10-25 — COP14 de la convention de Vienne et MOP39 du protocole de Montréal, jusqu'au 29 octobre, lieu à déterminer — [politique] — confirmé — https://ozone.unep.org/meetings (relevé le 2026-09-20) —
- 2027-12-30 — RDUE/EUDR : application aux produits ajoutés par le règlement délégué (UE) 2026/2102 (café soluble, certains dérivés de l'huile de palme…) — [politique] — confirmé — même source que 2026-12-30 —
- 2028 (jour non lu) — SEQE-2 / ETS2 (bâtiments, transport routier) : « fully operational in 2028 » — [politique] — confirmé — https://climate.ec.europa.eu/eu-action/carbon-markets/ets2-buildings-road-transport-and-additional-sectors_en (relevé le 2026-09-20) —

Repères de contexte lus le 2026-09-20, sans échéance à venir : la loi
européenne sur le climat modifiée (objectif de −90 % d'émissions nettes en
2040 par rapport à 1990, crédits internationaux « up to 5% ») est entrée en
...
403), prochaine session du comité de négociation du traité plastiques
(INC-5.4, aucune date sur la page du PNUE ; INC-5.3 tenue le 7 févr. 2026 à
...
dépêche, donc aucune date inscrite. Passage du 2026-09-21 à 20 h (brief) :
minimum arctique 2026 toujours non annoncé par le NSIDC (une estimation non
officielle circule : 4,60 M km² le 12 sept., blog de R. Thoman) ; communiqué
...
traiter comme engagements. Passage du 2026-09-22 à 19 h : minimum arctique
2026 toujours non annoncé par le NSIDC (dernière analyse : 3 sept. ; le site
indique que les annonces de minimum et maximum restent assurées malgré le
service réduit) ; vus seulement dans la presse spécialisée, donc non
inscrits faute de source officielle lisible : rapport sur le financement de
l'adaptation (PNACC 3) attendu le 30 sept. 2026 (Actu-Environnement, La France
Agricole ; ministère non consulté), transmission du PLF 2027 au Haut Conseil
des finances publiques (AEF, page budget.gouv.fr en erreur 403), plan
d'adaptation de l'UE attendu « octobre-novembre » 2026 (AEF) ; l'événement
climat de l'ONU du 23 sept. est confirmé sur https://www.un.org/en/climatechange/climate-summit-2026,
avec sept « dialogues de solutions » du 22 au 24 sept. ; aucune publication
nouvelle sur les sites de Copernicus (page d'actualités illisible), de la
Commission (dernier communiqué climat : 10 sept.) ni de l'OMM (21 sept. :
rapports iClimateAction sur la chaîne de données d'observation, non lus).
Passage du 2026-09-26 à 20 h (brief) : **minimum arctique 2026 annoncé par le
NSIDC le 23 sept.** (4,60 M km² le 12 sept., annonce préliminaire ; maximum
antarctique provisoire ~17,59 M km² le 14 sept.) — ligne de `reperes.md` mise
à jour, à retirer de cette liste ; l'événement climat de l'ONU du 23 sept. est
passé (retiré des échéances ; traité dans le brief du 26 sept. via la feuille
de route allemande et la déclaration de l'AGNU sur le niveau de la mer du
24 sept.) ; rapport sur le financement de l'adaptation (PNACC 3) toujours
attendu le 30 sept. selon la presse seulement, site du ministère illisible
(robots.txt), donc non inscrit ; sites d'Actu-Environnement et de
notre-environnement.gouv.fr illisibles ; prochaine mise à jour hebdomadaire
ENSO de la NOAA attendue le lundi 28 sept., discussion mensuelle du CPC début
octobre ; bulletin BRGM au 1er octobre attendu dans la deuxième semaine
d'octobre)_

## À réévaluer

Engagements, prépublications, attributions rapides et projections publiés avec
...
- 2026-09-21 — typhon Dujuan (Japon) : 600 mm en 24 h à Oshima, « record de septembre pour la station », un mort selon UPI (presse seulement, événement en cours) — note actuelle 6/10 — relevés de la JMA, bilan consolidé de l'agence japonaise de gestion des catastrophes, étude d'attribution éventuelle. Vu le 22 sept. à 7 h : Al Jazeera (d'après Kyodo) donne deux morts, des consignes d'évacuation pour plus de 1,6 million de personnes et des vents d'environ 144 km/h à 130 km au sud de Katsuura, le système s'éloignant vers le nord-est ; le Japan Times titre « au moins quatre morts et six disparus dans le Kanto » (article non lu, accès payant) ; bilan toujours provisoire, aucun relevé JMA lu directement, aucune attribution. Vu le 22 sept. à 19 h (titres seulement, articles non lus) : UPI et Malay Mail donnent six morts et au moins six disparus, Anadolu deux morts et quatre disparus, ABS-CBN 46 000 foyers sans électricité — bilans divergents selon l'heure de la dépêche, toujours provisoires. Mis à jour le 26 sept. (brief) : 12 morts (7 Chiba, 4 Kanagawa, 1 Miyazaki) et 3 disparus au 24 sept. selon la FDMA via *The Watchers* (TASS : 12 victimes, titre seul) ; 9 morts et 4 disparus le 23 sept. selon Kyodo / *Japan Today* ; 832 mm en 48 h à Oshima, record de la station depuis 1991 (JMA via *The Watchers*, non lu à la source) ; toujours aucune attribution (WWA : rien après le 17 sept.) — note 6/10 — ecologie/daily/2026/09/2026-09-21-brief-ecologie.md ; ecologie/daily/2026/09/2026-09-26-brief-ecologie.md
- 2026-09-22 — El Niño 2026 : anomalie journalière Niño-3.4 de 3,07 °C le 19 sept., « égalité statistique » avec le record de 2015 (Carbon Brief, Z. Hausfather ; référence non lue, non recoupée par la valeur hebdomadaire NOAA de +2,1 °C) — note actuelle 5/10 pour le rang « record », 7/10 pour l'alerte — lecture directe du fichier hebdomadaire NOAA (réf. 1991-2020) et de l'ONI v6 pour ASO 2026, prochaine discussion CPC (début octobre), mise à jour OMM, confirmation par ERSST ou ERA5 sur une même référence — ecologie/alerts/2026/09/2026-09-22-19-05-el-nino-2026-tres-fort-record-2015-noaa-historique.md
- 2026-09-22 — été 2026 en France : 2,4 °C [1,8-3,0] de l'anomalie de +5,0 °C (réf. préindustrielle) imputables au changement climatique (Météo-France, attribution rapide non relue) ; chiffres de l'été encore provisoires — note actuelle 7/10 (attribution), 8/10 (alerte) — bilan définitif de Météo-France, étude d'attribution relue ou WWA / ClimaMeter sur l'été français, bulletin BRGM au 1er octobre — ecologie/alerts/2026/09/2026-09-22-19-00-france-ete-2026-record-secheresse-sols-nappes.md
- 2026-09-26 — Allemagne : feuille de route de sortie des énergies fossiles d'ici 2045 (BMUKN, 23 sept.) ; le programme d'action climat 2026 réduirait les émissions de « plus de 27 Mt » d'ici 2030 (estimation gouvernementale) — note actuelle 5/10 — avis du Conseil d'experts sur le climat (Expertenrat für Klimafragen) et projections de l'Agence fédérale de l'environnement (UBA) sur l'atteinte des objectifs 2030 et 2040, inventaire 2025 consolidé, adoption des lois annoncées (quota gaz/chaleur neutres, loi de modernisation des bâtiments), date de sortie du charbon (2038 ou 2035) — ecologie/daily/2026/09/2026-09-26-brief-ecologie.md
